...
// acrescentei um chart.js para gráficos
...
export default function Login({ onPageChange, onLoginUser }) {
  ...
  // Dados estáticos do preview (não conectados ao backend ainda)
                    ...
                    >
                      {showPassword ? (
                        ...
                        <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-5 0-9.27-3.11-11-8 1.02-2.88 2.99-5.21 5.5-6.64"/>
                          <path d="M1 1l22 22"/>
